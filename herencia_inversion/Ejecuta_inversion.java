package herencia_inversion;
import java.util.Scanner;

public class Ejecuta_inversion {
        ...
        while(salir == true){
            ...
            switch (op){
                ...
                case 2:
                    ...
                    teclado.nextLine();
                    plazInver = teclado.nextDouble();
                    Pagares pagare = new Pagares(nomCliente, numCliente, numCuenta, capInvert, plazInver, inteAnual);
                ...
                case 3:
                    ...
                    teclado.nextLine();
                    plazInver = teclado.nextDouble();
                    Master master = new Master(nomCliente, numCliente, numCuenta, capInvert, plazInver, inteAnual);
                    cadena2 += "\t\t"+master.getNumCliente()+"\t\t\t  "+master.getNomCliente()
                            +"\t\t\t"+master.getNumCuenta()+"\t\t\t "+master.calcularInteresMaestra()+"\n";
                    break;
