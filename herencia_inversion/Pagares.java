...
public class Pagares extends Inversion {
    public Pagares(String nomCliente, int numCliente, int numCuenta, double capInvert, double plazInver, double inteAnual) {
