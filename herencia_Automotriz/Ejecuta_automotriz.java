...
public class Ejecuta_automotriz  {
        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    Administrativo empAdmvo = new Administrativo(nombre, departamento, puesto, sueldo_mensual);
                ...
                case 2:
                    ...
                    System.out.print("Ingrese puesto que ocupa: ");
                    puesto = teclado.nextLine();
                    Mecanico empMecanico = new Mecanico(nombre, departamento, puesto);
                ...
                case 3:
                    ...
                    System.out.print("Ingrese puesto que ocupa: ");
                    puesto = teclado.nextLine();
                    Vendedor empVendedor = new Vendedor(nombre, departamento, puesto);
